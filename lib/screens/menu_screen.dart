            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                return ListView.separated(
                    ...
                    itemCount: snapshot.data!.categories![4].products!.length,
                    itemBuilder: (context, itemindex) {
                      ...
                      // );
                      var data =
                          snapshot.data!.categories![4].products![itemindex];
                      double price = data.price!;
                      String itemName = data.nameJson!.english!;
                      String itemDesc = data.descriptionJson!.english!;
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: indexList.contains(itemindex)
                                  ? Container(
                                      height: 45,
                                      width: 90,
                                      decoration: BoxDecoration(
